  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground shadow-medium hover:shadow-strong transform hover:scale-105 transition-all duration-300",
        accent: "bg-gradient-accent text-accent-foreground shadow-soft hover:shadow-medium transform hover:scale-105",
        travel: "bg-travel-blue text-white shadow-soft hover:bg-travel-teal hover:shadow-medium transition-all duration-200",
      },
      size: {
